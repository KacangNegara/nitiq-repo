...
def landing_page():
    ...
    st.write("""
             ...
             """)
    st.write("---")
    st.write("Aplikasi ini dilatih menggunakan Batik Nitik 960, sebuah dataset yang terdiri dari 960 gambar dengan 60 motif Nitik berbeda dari Yogyakarta, Indonesia.")
    st.markdown("""
    ### Formulir Evaluasi
